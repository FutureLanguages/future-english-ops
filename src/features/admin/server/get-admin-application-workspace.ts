...
export async function getAdminApplicationWorkspaceViewModel(params: {
  ...
  return {
    ...
    tabs: [
      ...
      { id: "documents", label: "المستندات", href: "#documents" },
      { id: "payments", label: "المدفوعات", href: "#payments" },
      { id: "agreements", label: "المواثيق", href: "#agreements" },
      { id: "messages", label: "الرسائل", href: "#messages" },
      { id: "status", label: "الحالة", href: "#status" },
    ],
