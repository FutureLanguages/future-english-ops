  ...
  return (
    ...
    >
      ...
      <section className="rounded-panel bg-white p-5 shadow-soft">
        ...
        <div className="mt-4 h-[420px] overflow-y-auto scroll-smooth whitespace-pre-line rounded-2xl border border-black/10 bg-sand p-5 text-sm leading-8 text-ink shadow-inner md:h-[480px]">
